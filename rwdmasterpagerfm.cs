...
namespace GeneXus.Programs {
   public class rwdmasterpagerfm : GXMasterPage
   {
      public rwdmasterpagerfm( )
      {
      ...
      public rwdmasterpagerfm( IGxContext context )
      {
      ...
      protected void RenderHtmlCloseForm0F2( )
      {
         ...
         context.AddJavascriptSource("rwdmasterpagerfm.js", "?20209915511", false, true);
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)(getDataAreaObject() == null ? Form : getDataAreaObject().GetForm()).Jscriptsrc.Item(idxLst))), "?20209915514", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("rwdmasterpagerfm.js", "?20209915514", false, true);
         }
