...
gx.define('version1.wcfiltros', true, function (CmpContext) {
   this.ServerClass =  "version1.wcfiltros" ;
   ...
   GXValidFnc[8]={ id:8 ,lvl:0,type:"int",len:8,dec:0,sign:false,pic:"ZZZZZZZ9",ro:1,grid:0,gxgrid:null,fnc:null,isvalid:null,evt_cvc:null,evt_cvcing:null,rgrid:[],fld:"vCORTE1",gxz:"ZV5Corte1",gxold:"OV5Corte1",gxvar:"AV5Corte1",ucs:[],op:[],ip:[],
   ...
   GXValidFnc[12]={ id:12 ,lvl:0,type:"int",len:8,dec:0,sign:false,pic:"ZZZZZZZ9",ro:1,grid:0,gxgrid:null,fnc:null,isvalid:null,evt_cvc:null,evt_cvcing:null,rgrid:[],fld:"vCORTE2",gxz:"ZV6Corte2",gxold:"OV6Corte2",gxvar:"AV6Corte2",ucs:[],op:[],ip:[],
   ...
   GXValidFnc[14]={ id: 14, fld:"REFRESH",grid:0,evt:"e161i1_client"};
   this.AV5Corte1 = 0 ;
   this.ZV5Corte1 = 0 ;
   this.OV5Corte1 = 0 ;
   this.AV6Corte2 = 0 ;
   ...
   this.AV5Corte1 = 0 ;
   this.AV6Corte2 = 0 ;
   this.addContextSetter("vCORTE1", "Attribute", ["Corte1"], this.e121i2_client);
   this.addContextSetter("vCORTE2", "Attribute", ["Corte2"], this.e131i2_client);
   this.Events = {"e141i2_client": ["ENTER", true] ,"e151i2_client": ["CANCEL", true] ,"e121i2_client": ["CORTE1.SETCONTEXT", false] ,"e131i2_client": ["CORTE2.SETCONTEXT", false]};
