...
namespace GeneXus.Programs.version1 {
   public class tabbedview : GXWebComponent
   {
      ...
      public void execute( GXBaseCollection<GeneXus.Programs.version1.SdtTabOptions_TabOptionsItem> aP0_Tabs ,
                           String aP1_TabCode )
      {
         ...
         if ( StringUtil.Len( (String)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  setjustcreated();
                  componentprepare(new Object[] {(String)sCompPrefix,(String)sSFPrefix,(GXBaseCollection<GeneXus.Programs.version1.SdtTabOptions_TabOptionsItem>)AV18Tabs,(String)AV15TabCode});
                  componentstart();
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202091115385497", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.skipLines(1);
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"Form\" data-gx-class=\"Form\" novalidate action=\""+formatLink("version1.tabbedview.aspx") + "?" + UrlEncode(StringUtil.RTrim(AV15TabCode))+"\">") ;
      ...
      protected void RenderHtmlCloseForm0B2( )
      {
         ...
         {
            context.AddJavascriptSource("version1/tabbedview.js", "?20209111538550", false, true);
         }
      ...
      protected void WB0B0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "version1.tabbedview.aspx");
               context.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
               context.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
               context.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
               context.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      protected void S122( )
      {
         ...
         {
            AV14Tab = ((GeneXus.Programs.version1.SdtTabOptions_TabOptionsItem)AV18Tabs.Item(AV8Index));
      ...
      protected void S132( )
      {
         ...
         {
            if ( ( ( StringUtil.StrCmp(Historymanager_Hash, "") == 0 ) && ( ( StringUtil.StrCmp(((GeneXus.Programs.version1.SdtTabOptions_TabOptionsItem)AV18Tabs.Item(AV8Index)).gxTpr_Code, AV15TabCode) == 0 ) ) ) || ( ( StringUtil.StrCmp(((GeneXus.Programs.version1.SdtTabOptions_TabOptionsItem)AV18Tabs.Item(AV8Index)).gxTpr_Code, Historymanager_Hash) == 0 ) ) )
            {
      ...
      protected void wb_table1_2_0B2( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTabs_Internalname, lblTabs_Caption, "", "", lblTabs_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", 0, "", 1, 1, 1, "HLP_Version1\\TabbedView.htm");
            /* Static images/pictures */
            ClassString = "TabPagingPrevious";
            StyleString = "";
            sImgUrl = "(none)";
            GxWebStd.gx_bitmap( context, imgTabprevious_Internalname, sImgUrl, "", "", "", context.GetTheme( ), imgTabprevious_Visible, 1, "", "Previous Tab", 0, 0, 0, "px", 0, "px", 0, 0, 0, "", "", StyleString, ClassString, "", "", "", "", "", "", "", 1, false, false, context.GetImageSrcSet( sImgUrl), "HLP_Version1\\TabbedView.htm");
            /* Static images/pictures */
            ClassString = "TabPagingNext";
            StyleString = "";
            sImgUrl = "(none)";
            GxWebStd.gx_bitmap( context, imgTabnext_Internalname, sImgUrl, "", "", "", context.GetTheme( ), imgTabnext_Visible, 1, "", "Next Tab", 0, 0, 0, "px", 0, "px", 0, 0, 0, "", "", StyleString, ClassString, "", "", "", "", "", "", "", 1, false, false, context.GetImageSrcSet( sImgUrl), "HLP_Version1\\TabbedView.htm");
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV18Tabs = (GXBaseCollection<GeneXus.Programs.version1.SdtTabOptions_TabOptionsItem>)getParm(obj,0);
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "version1\\tabbedview", GetJustCreated( ));
         ...
         {
            AV18Tabs = (GXBaseCollection<GeneXus.Programs.version1.SdtTabOptions_TabOptionsItem>)getParm(obj,2);
      ...
      protected void WCParametersGet( )
      {
         ...
         {
            AV18Tabs = new GXBaseCollection<GeneXus.Programs.version1.SdtTabOptions_TabOptionsItem>();
         }
         else
         {
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?202091115385528", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("version1/tabbedview.js", "?202091115385528", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      {
         AV18Tabs = new GXBaseCollection<GeneXus.Programs.version1.SdtTabOptions_TabOptionsItem>( context, "TabOptionsItem", "RFM");
         wcpOAV15TabCode = "";
         Historymanager_Hash = "";
         gxfirstwebparm = "";
         gxfirstwebparm_bkp = "";
         ...
         AV20TabTemplate = "";
         GXKey = "";
         AV14Tab = new GeneXus.Programs.version1.SdtTabOptions_TabOptionsItem(context);
         AV19TabsMarkup = "";
         GX_FocusControl = "";
      ...
      private GXBaseCollection<GeneXus.Programs.version1.SdtTabOptions_TabOptionsItem> AV18Tabs ;
      private GeneXus.Programs.version1.SdtTabOptions_TabOptionsItem AV14Tab ;
   }
