...
namespace GeneXus.Programs.version1 {
   public class wcpiechartcli : GXWebComponent
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202091115385420", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            if ( nGXWrapped != 1 )
            {
               context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("version1.wcpiechartcli.aspx") + "?" + UrlEncode("" +AV18corte1) + "," + UrlEncode("" +AV19corte2)+"\">") ;
      ...
      protected void RenderHtmlCloseForm0U2( )
      {
         ...
         {
            context.AddJavascriptSource("version1/wcpiechartcli.js", "?202091115385430", false, true);
         }
      ...
      protected void WB0U0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "version1.wcpiechartcli.aspx");
               context.AddJavascriptSource("QueryViewer/QueryViewerCommon.js", "", false, true);
               context.AddJavascriptSource("QueryViewer/highcharts/highcharts.js", "", false, true);
               context.AddJavascriptSource("QueryViewer/highcharts/highcharts-3d.js", "", false, true);
               context.AddJavascriptSource("QueryViewer/highcharts/highcharts-more.js", "", false, true);
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "version1\\wcpiechartcli", GetJustCreated( ));
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("version1/wcpiechartcli.js", "?202091115385472", false, true);
            context.AddJavascriptSource("QueryViewer/QueryViewerCommon.js", "", false, true);
            context.AddJavascriptSource("QueryViewer/highcharts/highcharts.js", "", false, true);
            context.AddJavascriptSource("QueryViewer/highcharts/highcharts-3d.js", "", false, true);
            context.AddJavascriptSource("QueryViewer/highcharts/highcharts-more.js", "", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         init_default_properties( ) ;
         Queryviewer1_Title = "Clientes Fidelizados";
      ...
      public override void initialize( )
      {
         ...
         bodyStyle = "";
         GXKey = "";
         AV20sdtCorte = new GeneXus.Programs.version1.SdtSDTCorte(context);
      ...
      private GeneXus.Programs.version1.SdtSDTCorte AV20sdtCorte ;
   }
