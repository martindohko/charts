...
gx.define('version1.wcpiecharttks', true, function (CmpContext) {
   this.ServerClass =  "version1.wcpiecharttks" ;
   ...
   QUERYVIEWER1Container.setProp("ObjectId", "Objectid", "12", "str");
   ...
   QUERYVIEWER1Container.setProp("ObjectName", "Objectname", "QPieChartTks", "str");
   ...
   QUERYVIEWER1Container.setProp("Title", "Title", "Tickets", "str");
