...
namespace GeneXus.Programs.version1 {
   public class rwdrecentlinks : GXWebComponent
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202091115385527", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.skipLines(1);
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("version1.rwdrecentlinks.aspx") + "?" + UrlEncode(StringUtil.RTrim(AV6FormCaption)) + "," + UrlEncode(StringUtil.RTrim(AV7FormPgmName))+"\">") ;
      ...
      protected void RenderHtmlCloseForm052( )
      {
         ...
         {
            context.AddJavascriptSource("version1/rwdrecentlinks.js", "?202091115385529", false, true);
         }
      ...
      {
         return "Version1.RwdRecentLinks" ;
      }
      ...
      protected void WB050( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "version1.rwdrecentlinks.aspx");
            }
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblRecenttext_Internalname, "Recents", "", "", lblRecenttext_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+"e11051_client"+"'", "", "RecentsTitle", 7, "", 1, 1, 0, "HLP_Version1\\RwdRecentLinks.htm");
      ...
      private void E12052( )
      {
         ...
         {
            AV12RecentLinksItem = ((GeneXus.Programs.version1.SdtLinkList_LinkItem)AV11RecentLinksItems.Item(AV9i));
         ...
         AV12RecentLinksItem = new GeneXus.Programs.version1.SdtLinkList_LinkItem(context);
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "version1\\rwdrecentlinks", GetJustCreated( ));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?202091115385543", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("version1/rwdrecentlinks.js", "?202091115385543", false, true);
      ...
      public override void initialize( )
      {
         ...
         EvtRowId = "";
         sEvtType = "";
         AV11RecentLinksItems = new GXBaseCollection<GeneXus.Programs.version1.SdtLinkList_LinkItem>( context, "LinkItem", "GeneXus");
      ...
      private GXBaseCollection<GeneXus.Programs.version1.SdtLinkList_LinkItem> AV11RecentLinksItems ;
      private GeneXus.Programs.version1.SdtLinkList_LinkItem AV12RecentLinksItem ;
   }
