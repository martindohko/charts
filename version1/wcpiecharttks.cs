...
namespace GeneXus.Programs.version1 {
   public class wcpiecharttks : GXWebComponent
   {
      public wcpiecharttks( )
      {
      ...
      public wcpiecharttks( IGxContext context )
      {
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "WCPie Chart Tks") ;
         ...
         context.AddJavascriptSource("gxcfg.js", "?202091115385255", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            if ( nGXWrapped != 1 )
            {
               context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("version1.wcpiecharttks.aspx") +"\">") ;
      ...
      protected void RenderHtmlCloseForm192( )
      {
         ...
         {
            context.AddJavascriptSource("version1/wcpiecharttks.js", "?202091115385264", false, true);
         }
      ...
      {
         return "Version1.WCPieChartTks" ;
      }

      public override String GetPgmdesc( )
      {
         return "WCPie Chart Tks" ;
      }
      ...
      protected void WB190( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "version1.wcpiecharttks.aspx");
               context.AddJavascriptSource("QueryViewer/QueryViewerCommon.js", "", false, true);
               context.AddJavascriptSource("QueryViewer/highcharts/highcharts.js", "", false, true);
               context.AddJavascriptSource("QueryViewer/highcharts/highcharts-3d.js", "", false, true);
               context.AddJavascriptSource("QueryViewer/highcharts/highcharts-more.js", "", false, true);
      ...
      protected void START192( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            if ( ! context.isSpaRequest( ) )
            {
               ...
               Form.Meta.addItem("description", "WCPie Chart Tks", 0) ;
            }
            context.wjLoc = "";
      ...
      protected void E11192( )
      {
         ...
         GXt_int2 = (short)(AV17corte1);
         GXt_int3 = (short)(AV18corte2);
         new GeneXus.Programs.version1.pparametros(context ).execute( ref  GXt_char1, ref  GXt_int2, ref  GXt_int3) ;
         AV17corte1 = GXt_int2;
         AV18corte2 = GXt_int3;
         AssignAttri(sPrefix, false, "AV17corte1", StringUtil.LTrimStr( (decimal)(AV17corte1), 8, 0));
         AssignAttri(sPrefix, false, "AV18corte2", StringUtil.LTrimStr( (decimal)(AV18corte2), 8, 0));
         AV8Parameter = new GeneXus.Programs.version1.SdtQueryViewerParameters_Parameter(context);
         AV8Parameter.gxTpr_Name = "Corte1";
         AV8Parameter.gxTpr_Value = StringUtil.Str( (decimal)(AV17corte1), 8, 0);
         AV7Parameters.Add(AV8Parameter, 0);
         AV8Parameter = new GeneXus.Programs.version1.SdtQueryViewerParameters_Parameter(context);
         AV8Parameter.gxTpr_Name = "Corte2";
         AV8Parameter.gxTpr_Value = StringUtil.Str( (decimal)(AV18corte2), 8, 0);
         AV7Parameters.Add(AV8Parameter, 0);
      }
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "version1\\wcpiecharttks", GetJustCreated( ));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?20209111538532", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("version1/wcpiecharttks.js", "?20209111538533", false, true);
            context.AddJavascriptSource("QueryViewer/QueryViewerCommon.js", "", false, true);
            context.AddJavascriptSource("QueryViewer/highcharts/highcharts.js", "", false, true);
            context.AddJavascriptSource("QueryViewer/highcharts/highcharts-3d.js", "", false, true);
            context.AddJavascriptSource("QueryViewer/highcharts/highcharts-more.js", "", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         init_default_properties( ) ;
         Queryviewer1_Title = "Tickets";
         Queryviewer1_Objectname = "QPieChartTks";
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            if ( context.isSpaRequest( ) )
            {
      ...
      public override void initialize( )
      {
         ...
         bodyStyle = "";
         GXKey = "";
         AV9Axes = new GXBaseCollection<GeneXus.Programs.version1.SdtQueryViewerAxes_Axis>( context, "Axis", "RFM");
         AV7Parameters = new GXBaseCollection<GeneXus.Programs.version1.SdtQueryViewerParameters_Parameter>( context, "Parameter", "RFM");
         AV15ItemClickData = new GeneXus.Programs.version1.SdtQueryViewerItemClickData(context);
         AV16ItemDoubleClickData = new GeneXus.Programs.version1.SdtQueryViewerItemDoubleClickData(context);
         AV11DragAndDropData = new GeneXus.Programs.version1.SdtQueryViewerDragAndDropData(context);
         AV14FilterChangedData = new GeneXus.Programs.version1.SdtQueryViewerFilterChangedData(context);
         AV12ItemExpandData = new GeneXus.Programs.version1.SdtQueryViewerItemExpandData(context);
         AV13ItemCollapseData = new GeneXus.Programs.version1.SdtQueryViewerItemCollapseData(context);
         GX_FocusControl = "";
      ...
      private int AV17corte1 ;
      private int AV18corte2 ;
      private int idxLst ;
      ...
      private GXBaseCollection<GeneXus.Programs.version1.SdtQueryViewerParameters_Parameter> AV7Parameters ;
      private GXBaseCollection<GeneXus.Programs.version1.SdtQueryViewerAxes_Axis> AV9Axes ;
      private GeneXus.Programs.version1.SdtQueryViewerParameters_Parameter AV8Parameter ;
      private GeneXus.Programs.version1.SdtQueryViewerDragAndDropData AV11DragAndDropData ;
      private GeneXus.Programs.version1.SdtQueryViewerItemExpandData AV12ItemExpandData ;
      private GeneXus.Programs.version1.SdtQueryViewerItemCollapseData AV13ItemCollapseData ;
      private GeneXus.Programs.version1.SdtQueryViewerFilterChangedData AV14FilterChangedData ;
      private GeneXus.Programs.version1.SdtQueryViewerItemClickData AV15ItemClickData ;
      private GeneXus.Programs.version1.SdtQueryViewerItemDoubleClickData AV16ItemDoubleClickData ;
   }
