...
namespace GeneXus.Programs.version1 {
   public class tresumenrfm_bc : GxSilentTrn, IGxSilentTrn
   {
      ...
      {
         VarsToRow1( bcversion1_tResumenRFM) ;
      }

      protected void ReadRow011( )
      {
         RowToVars1( bcversion1_tResumenRFM, 1) ;
      }
      ...
      public void VarsToRow1( GeneXus.Programs.version1.SdttResumenRFM obj1 )
      {
      ...
      public void KeyVarsToRow1( GeneXus.Programs.version1.SdttResumenRFM obj1 )
      {
         obj1.gxTpr_Region = A1Region;
         obj1.gxTpr_Sucursal = A2Sucursal;
         return  ;
      ...
      public void RowToVars1( GeneXus.Programs.version1.SdttResumenRFM obj1 ,
                              int forceLoad )
      {
      ...
      public void Load( )
      {
         ...
         BackMsgLst = context.GX_msglist;
         context.GX_msglist = LclMsgLst;
         RowToVars1( bcversion1_tResumenRFM, 0) ;
         ScanKeyStart011( ) ;
         if ( RcdFound1 == 0 )
         {
            Gx_mode = "INS";
      ...
      protected void UpdateImpl( )
      {
         ...
         {
            GeneXus.Programs.version1.SdttResumenRFM auxBC = new GeneXus.Programs.version1.SdttResumenRFM(context) ;
            IGxSilentTrn auxTrn = auxBC.getTransaction() ;
            auxBC.Load(A1Region, A2Sucursal);
            if ( auxTrn.Errors() == 0 )
            {
               auxBC.UpdateDirties(bcversion1_tResumenRFM);
               auxBC.Save();
            }
      ...
      public void Check( )
      {
         ...
         pr_default.close(1);
         context.RollbackDataStores("version1.tresumenrfm_bc",pr_default);
         VarsToRow1( bcversion1_tResumenRFM) ;
         context.GX_msglist = BackMsgLst;
         return  ;
      }
      ...
      {
         Gx_mode = bcversion1_tResumenRFM.gxTpr_Mode;
         return Gx_mode ;
      }
      ...
      {
         Gx_mode = lMode;
         bcversion1_tResumenRFM.gxTpr_Mode = Gx_mode;
         return  ;
      }
      ...
      public void SetSDT( GxSilentTrnSdt sdt ,
                          short sdtToBc )
      {
         if ( sdt != bcversion1_tResumenRFM )
         {
            bcversion1_tResumenRFM = (GeneXus.Programs.version1.SdttResumenRFM)(sdt);
            if ( StringUtil.StrCmp(bcversion1_tResumenRFM.gxTpr_Mode, "") == 0 )
            {
               bcversion1_tResumenRFM.gxTpr_Mode = "INS";
            }
            if ( sdtToBc == 1 )
            {
               VarsToRow1( bcversion1_tResumenRFM) ;
      ...
      public override void initialize( )
      {
         ...
         pr_gam = new DataStoreProvider(context, new GeneXus.Programs.version1.tresumenrfm_bc__gam(),
            new Object[][] {
            }
         );
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.version1.tresumenrfm_bc__default(),
            new Object[][] {
                new Object[] {
      ...
      private GeneXus.Programs.version1.SdttResumenRFM bcversion1_tResumenRFM ;
   ...
   public class tresumenrfm_bc__gam : DataStoreHelperBase, IDataStoreHelper
   {
