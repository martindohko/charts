...
namespace GeneXus.Programs.version1 {
   public class wclinechart : GXWebComponent
   {
      public wclinechart( )
      {
      ...
      public wclinechart( IGxContext context )
      {
      ...
      public void execute( ref int aP0_corte1 ,
                           ref int aP1_corte2 )
      {
         this.AV20corte1 = aP0_corte1;
         this.AV19corte2 = aP1_corte2;
         executePrivate();
         aP0_corte1=this.AV20corte1;
         ...
         if ( StringUtil.Len( (String)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  AV20corte1 = (int)(NumberUtil.Val( GetNextPar( ), "."));
                  AssignAttri(sPrefix, false, "AV20corte1", StringUtil.LTrimStr( (decimal)(AV20corte1), 8, 0));
                  AV19corte2 = (int)(NumberUtil.Val( GetNextPar( ), "."));
                  AssignAttri(sPrefix, false, "AV19corte2", StringUtil.LTrimStr( (decimal)(AV19corte2), 8, 0));
                  setjustcreated();
                  componentprepare(new Object[] {(String)sCompPrefix,(String)sSFPrefix,(int)AV20corte1,(int)AV19corte2});
                  componentstart();
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "WCLine Chart") ;
         ...
         context.AddJavascriptSource("gxcfg.js", "?202091115385467", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            if ( nGXWrapped != 1 )
            {
               context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("version1.wclinechart.aspx") + "?" + UrlEncode("" +AV20corte1) + "," + UrlEncode("" +AV19corte2)+"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"wcpOAV20corte1", StringUtil.LTrim( StringUtil.NToC( (decimal)(wcpOAV20corte1), 8, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, sPrefix+"wcpOAV19corte2", StringUtil.LTrim( StringUtil.NToC( (decimal)(wcpOAV19corte2), 8, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, sPrefix+"vCORTE1", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV20corte1), 8, 0, ".", "")));
      ...
      protected void RenderHtmlCloseForm0M2( )
      {
         ...
         {
            context.AddJavascriptSource("version1/wclinechart.js", "?202091115385477", false, true);
         }
      ...
      protected void WB0M0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "version1.wclinechart.aspx");
               context.AddJavascriptSource("QueryViewer/QueryViewerCommon.js", "", false, true);
               context.AddJavascriptSource("QueryViewer/highcharts/highcharts.js", "", false, true);
               context.AddJavascriptSource("QueryViewer/highcharts/highcharts-3d.js", "", false, true);
               context.AddJavascriptSource("QueryViewer/highcharts/highcharts-more.js", "", false, true);
      ...
      protected void START0M2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            if ( ! context.isSpaRequest( ) )
            {
               ...
               Form.Meta.addItem("description", "WCLine Chart", 0) ;
            }
            context.wjLoc = "";
      ...
      protected void STRUP0M0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            /* Read saved values. */
            wcpOAV20corte1 = (int)(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV20corte1"), ".", ","));
      ...
      {
         /* Load Routine */
         AV10Parameter = new GeneXus.Programs.version1.SdtQueryViewerParameters_Parameter(context);
         AV10Parameter.gxTpr_Name = "Corte1";
         AV10Parameter.gxTpr_Value = StringUtil.Str( (decimal)(AV20corte1), 8, 0);
         AV9Parameters.Add(AV10Parameter, 0);
         AV10Parameter = new GeneXus.Programs.version1.SdtQueryViewerParameters_Parameter(context);
         AV10Parameter.gxTpr_Name = "Corte2";
         AV10Parameter.gxTpr_Value = StringUtil.Str( (decimal)(AV19corte2), 8, 0);
         AV9Parameters.Add(AV10Parameter, 0);
      }
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV20corte1 = Convert.ToInt32(getParm(obj,0));
         AssignAttri(sPrefix, false, "AV20corte1", StringUtil.LTrimStr( (decimal)(AV20corte1), 8, 0));
      ...
      public override void componentbind( Object[] obj )
      {
         ...
         sCtrlAV20corte1 = (String)((String)getParm(obj,0));
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "version1\\wclinechart", GetJustCreated( ));
         ...
         {
            AV20corte1 = Convert.ToInt32(getParm(obj,2));
            AssignAttri(sPrefix, false, "AV20corte1", StringUtil.LTrimStr( (decimal)(AV20corte1), 8, 0));
         ...
         wcpOAV20corte1 = (int)(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV20corte1"), ".", ","));
         wcpOAV19corte2 = (int)(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV19corte2"), ".", ","));
         if ( ! GetJustCreated( ) && ( ( AV20corte1 != wcpOAV20corte1 ) || ( AV19corte2 != wcpOAV19corte2 ) ) )
         {
            setjustcreated();
         }
         wcpOAV20corte1 = AV20corte1;
      ...
      protected void WCParametersGet( )
      {
         ...
         sCtrlAV20corte1 = cgiGet( sPrefix+"AV20corte1_CTRL");
         if ( StringUtil.Len( sCtrlAV20corte1) > 0 )
         {
            AV20corte1 = (int)(context.localUtil.CToN( cgiGet( sCtrlAV20corte1), ".", ","));
            AssignAttri(sPrefix, false, "AV20corte1", StringUtil.LTrimStr( (decimal)(AV20corte1), 8, 0));
         }
         else
         {
            AV20corte1 = (int)(context.localUtil.CToN( cgiGet( sPrefix+"AV20corte1_PARM"), ".", ","));
         }
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"AV20corte1_PARM", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV20corte1), 8, 0, ".", "")));
         if ( StringUtil.Len( StringUtil.RTrim( sCtrlAV20corte1)) > 0 )
         {
            GxWebStd.gx_hidden_field( context, sPrefix+"AV20corte1_CTRL", StringUtil.RTrim( sCtrlAV20corte1));
         }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?202091115385515", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("version1/wclinechart.js", "?202091115385516", false, true);
            context.AddJavascriptSource("QueryViewer/QueryViewerCommon.js", "", false, true);
            context.AddJavascriptSource("QueryViewer/highcharts/highcharts.js", "", false, true);
            context.AddJavascriptSource("QueryViewer/highcharts/highcharts-3d.js", "", false, true);
            context.AddJavascriptSource("QueryViewer/highcharts/highcharts-more.js", "", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         init_default_properties( ) ;
         Queryviewer1_Title = "";
         Queryviewer1_Objectname = "QLineChart";
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            if ( context.isSpaRequest( ) )
            {
      ...
      public override void initialize( )
      {
         ...
         bodyStyle = "";
         GXKey = "";
         AV11Axes = new GXBaseCollection<GeneXus.Programs.version1.SdtQueryViewerAxes_Axis>( context, "Axis", "RFM");
         AV9Parameters = new GXBaseCollection<GeneXus.Programs.version1.SdtQueryViewerParameters_Parameter>( context, "Parameter", "RFM");
         AV17ItemClickData = new GeneXus.Programs.version1.SdtQueryViewerItemClickData(context);
         AV18ItemDoubleClickData = new GeneXus.Programs.version1.SdtQueryViewerItemDoubleClickData(context);
         AV13DragAndDropData = new GeneXus.Programs.version1.SdtQueryViewerDragAndDropData(context);
         AV16FilterChangedData = new GeneXus.Programs.version1.SdtQueryViewerFilterChangedData(context);
         AV14ItemExpandData = new GeneXus.Programs.version1.SdtQueryViewerItemExpandData(context);
         AV15ItemCollapseData = new GeneXus.Programs.version1.SdtQueryViewerItemCollapseData(context);
         GX_FocusControl = "";
      ...
      private int AV20corte1 ;
      private int AV19corte2 ;
      private int wcpOAV20corte1 ;
      ...
      private String sCtrlAV20corte1 ;
      ...
      private GXBaseCollection<GeneXus.Programs.version1.SdtQueryViewerParameters_Parameter> AV9Parameters ;
      private GXBaseCollection<GeneXus.Programs.version1.SdtQueryViewerAxes_Axis> AV11Axes ;
      private GeneXus.Programs.version1.SdtQueryViewerParameters_Parameter AV10Parameter ;
      private GeneXus.Programs.version1.SdtQueryViewerDragAndDropData AV13DragAndDropData ;
      private GeneXus.Programs.version1.SdtQueryViewerItemExpandData AV14ItemExpandData ;
      private GeneXus.Programs.version1.SdtQueryViewerItemCollapseData AV15ItemCollapseData ;
      private GeneXus.Programs.version1.SdtQueryViewerFilterChangedData AV16FilterChangedData ;
      private GeneXus.Programs.version1.SdtQueryViewerItemClickData AV17ItemClickData ;
      private GeneXus.Programs.version1.SdtQueryViewerItemDoubleClickData AV18ItemDoubleClickData ;
   }
