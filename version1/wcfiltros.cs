...
namespace GeneXus.Programs.version1 {
   public class wcfiltros : GXWebComponent
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202091115385355", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.skipLines(1);
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("version1.wcfiltros.aspx") + "?" + UrlEncode("" +AV5Corte1) + "," + UrlEncode("" +AV6Corte2)+"\">") ;
      ...
      protected void RenderHtmlCloseForm1I2( )
      {
         ...
         {
            context.AddJavascriptSource("version1/wcfiltros.js", "?202091115385356", false, true);
         }
      ...
      protected void WB1I0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "version1.wcfiltros.aspx");
            }
            ...
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, dynavCorte1, dynavCorte1_Internalname, StringUtil.Trim( StringUtil.Str( (decimal)(AV5Corte1), 8, 0)), 1, dynavCorte1_Jsonclick, 0, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "int", "", 1, dynavCorte1.Enabled, 0, 0, 0, "em", 0, "", "", "Attribute", "", "", "", "", false, "HLP_Version1\\WCFiltros.htm");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "left", "top", "", "", "div");
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, dynavCorte2, dynavCorte2_Internalname, StringUtil.Trim( StringUtil.Str( (decimal)(AV6Corte2), 8, 0)), 1, dynavCorte2_Jsonclick, 0, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "int", "", 1, dynavCorte2.Enabled, 0, 0, 0, "em", 0, "", "", "Attribute", "", "", "", "", false, "HLP_Version1\\WCFiltros.htm");
            ...
            ClassString = "Button";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttRefresh_Internalname, "", "Refresh", bttRefresh_Jsonclick, 8, "Refresh", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"EREFRESH."+"'", TempTags, "", context.GetButtonType( ), "HLP_Version1\\WCFiltros.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "version1\\wcfiltros", GetJustCreated( ));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?202091115385374", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("version1/wcfiltros.js", "?202091115385374", false, true);
      ...
      public override void initialize( )
      {
         ...
         sCtrlAV5Corte1 = "";
         sCtrlAV6Corte2 = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.version1.wcfiltros__default(),
            new Object[][] {
                new Object[] {
