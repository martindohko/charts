...
namespace GeneXus.Programs.version1 {
   public class wpinicio : GXDataArea
   {
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            MasterPageObj = (GXMasterPage) ClassLoader.GetInstance("version1.rwdmasterpagerfm", "GeneXus.Programs.version1.rwdmasterpagerfm", new Object[] {new GxContext( context.handle, context.DataStores, context.HttpContext)});
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202091115385871", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("version1.wpinicio.aspx") +"\">") ;
      ...
      {
         return formatLink("version1.wpinicio.aspx")  ;
      }

      public override String GetPgmname( )
      {
         return "Version1.WPInicio" ;
      }
               ...
               if ( StringUtil.Len( sEvt) > 0 )
               {
                  ...
                  if ( StringUtil.StrCmp(sEvtType, "M") != 0 )
                  {
                     ...
                     else if ( StringUtil.StrCmp(sEvtType, "W") == 0 )
                     {
                        ...
                        if ( nCmpId == 6 )
                        {
                           WebComp_Component6 = getWebComponent(GetType(), "GeneXus.Programs", "version1.wccantcli", new Object[] {context} );
                           WebComp_Component6.ComponentInit();
                           WebComp_Component6.Name = "Version1.WCCantCli";
                           WebComp_Component6_Component = "Version1.WCCantCli";
                        ...
                        {
                           WebComp_Component4 = getWebComponent(GetType(), "GeneXus.Programs", "version1.wcpiechartfac", new Object[] {context} );
                           WebComp_Component4.ComponentInit();
                           WebComp_Component4.Name = "Version1.WCPieChartFac";
                           WebComp_Component4_Component = "Version1.WCPieChartFac";
                           WebComp_Component4.componentprocess("W0011", "", sEvt);
                        }
                        else if ( nCmpId == 13 )
                        {
                           WebComp_Component5 = getWebComponent(GetType(), "GeneXus.Programs", "version1.wcpiecharttks", new Object[] {context} );
                           WebComp_Component5.ComponentInit();
                           WebComp_Component5.Name = "Version1.WCPieChartTks";
                           WebComp_Component5_Component = "Version1.WCPieChartTks";
                           WebComp_Component5.componentprocess("W0013", "", sEvt);
                        }
                        else if ( nCmpId == 19 )
                        {
                           WebComp_Component2 = getWebComponent(GetType(), "GeneXus.Programs", "version1.wccolumnchart", new Object[] {context} );
                           WebComp_Component2.ComponentInit();
                           WebComp_Component2.Name = "Version1.WCColumnChart";
                           WebComp_Component2_Component = "Version1.WCColumnChart";
                           WebComp_Component2.componentprocess("W0019", "", sEvt);
                        }
                        else if ( nCmpId == 21 )
                        {
                           WebComp_Component8 = getWebComponent(GetType(), "GeneXus.Programs", "version1.wctable", new Object[] {context} );
                           WebComp_Component8.ComponentInit();
                           WebComp_Component8.Name = "Version1.WCTable";
                           WebComp_Component8_Component = "Version1.WCTable";
                           WebComp_Component8.componentprocess("W0021", "", sEvt);
                        }
                        else if ( nCmpId == 24 )
                        {
                           WebComp_Component10 = getWebComponent(GetType(), "GeneXus.Programs", "version1.wctable", new Object[] {context} );
                           WebComp_Component10.ComponentInit();
                           WebComp_Component10.Name = "Version1.WCTable";
                           WebComp_Component10_Component = "Version1.WCTable";
                           WebComp_Component10.componentprocess("W0024", "", sEvt);
                        }
                        else if ( nCmpId == 26 )
                        {
                           WebComp_Component9 = getWebComponent(GetType(), "GeneXus.Programs", "version1.wctable2", new Object[] {context} );
                           WebComp_Component9.ComponentInit();
                           WebComp_Component9.Name = "Version1.WCTable2";
                           WebComp_Component9_Component = "Version1.WCTable2";
                           WebComp_Component9.componentprocess("W0026", "", sEvt);
                        }
                        else if ( nCmpId == 29 )
                        {
                           WebComp_Component3 = getWebComponent(GetType(), "GeneXus.Programs", "version1.wcsankey", new Object[] {context} );
                           WebComp_Component3.ComponentInit();
                           WebComp_Component3.Name = "Version1.WCSankey";
                           WebComp_Component3_Component = "Version1.WCSankey";
                           WebComp_Component3.componentprocess("W0029", "", sEvt);
                        }
                        else if ( nCmpId == 32 )
                        {
                           WebComp_Component7 = getWebComponent(GetType(), "GeneXus.Programs", "version1.wclinechartfac", new Object[] {context} );
                           WebComp_Component7.ComponentInit();
                           WebComp_Component7.Name = "Version1.WCLineChartFac";
                           WebComp_Component7_Component = "Version1.WCLineChartFac";
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?202091115385919", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("version1/wpinicio.js", "?202091115385919", false, true);
