...
namespace GeneXus.Programs.version1 {
   public class wwtresumenrfm : GXHttpHandler
   {
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV22Pgmname = "Version1.WWtResumenRFM";
               context.Gx_err = 0;
               WS0D2( ) ;
               if ( ! isAjaxCallMode( ) )
               {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202091115385638", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("version1.wwtresumenrfm.aspx") +"\">") ;
      ...
      protected void WB0D0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtntoggle_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(55), 2, 0)+","+"null"+");", bttBtntoggle_Caption, bttBtntoggle_Jsonclick, 7, "Hide Filters", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e110d1_client"+"'", TempTags, "", 2, "HLP_Version1\\WWtResumenRFM.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-6 col-sm-2", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTitletext_Internalname, "t Resumen RFMs", "", "", lblTitletext_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "SubTitle", 0, "", 1, 1, 0, "HLP_Version1\\WWtResumenRFM.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblsucursalfilter_Internalname, lblLblsucursalfilter_Caption, "", "", lblLblsucursalfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e120d1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 1, "HLP_Version1\\WWtResumenRFM.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavSucursal_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV18Sucursal), 4, 0, ".", "")), ((edtavSucursal_Enabled!=0) ? StringUtil.LTrim( context.localUtil.Format( (decimal)(AV18Sucursal), "ZZZ9")) : context.localUtil.Format( (decimal)(AV18Sucursal), "ZZZ9")), TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,27);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavSucursal_Jsonclick, 0, "FilterComboAttribute", "", "", "", "", edtavSucursal_Visible, edtavSucursal_Enabled, 0, "number", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_Version1\\WWtResumenRFM.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblrfmantfilter_Internalname, lblLblrfmantfilter_Caption, "", "", lblLblrfmantfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e130d1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 1, "HLP_Version1\\WWtResumenRFM.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblrfmactfilter_Internalname, lblLblrfmactfilter_Caption, "", "", lblLblrfmactfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e140d1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 1, "HLP_Version1\\WWtResumenRFM.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
      ...
      {
         /* Start Routine */
         if ( ! new GeneXus.Programs.version1.isauthorized(context).executeUdp(  AV22Pgmname) )
         {
            CallWebObject(formatLink("version1.notauthorized.aspx") + "?" + UrlEncode(StringUtil.RTrim(AV22Pgmname)));
      ...
      protected void S122( )
      {
         ...
         if ( StringUtil.StrCmp(AV7HTTPRequest.Method, "GET") == 0 )
         {
            ...
            {
               AV17Region = (short)(NumberUtil.Val( ((GeneXus.Programs.version1.SdtGridState_FilterValue)AV8GridState.gxTpr_Filtervalues.Item(1)).gxTpr_Value, "."));
               AssignAttri("", false, "AV17Region", StringUtil.LTrimStr( (decimal)(AV17Region), 4, 0));
               AV18Sucursal = (short)(NumberUtil.Val( ((GeneXus.Programs.version1.SdtGridState_FilterValue)AV8GridState.gxTpr_Filtervalues.Item(2)).gxTpr_Value, "."));
               AssignAttri("", false, "AV18Sucursal", StringUtil.LTrimStr( (decimal)(AV18Sucursal), 4, 0));
               AV13RFMAnt = (int)(NumberUtil.Val( ((GeneXus.Programs.version1.SdtGridState_FilterValue)AV8GridState.gxTpr_Filtervalues.Item(3)).gxTpr_Value, "."));
               AssignAttri("", false, "AV13RFMAnt", StringUtil.LTrimStr( (decimal)(AV13RFMAnt), 8, 0));
               AV19RFMAct = (int)(NumberUtil.Val( ((GeneXus.Programs.version1.SdtGridState_FilterValue)AV8GridState.gxTpr_Filtervalues.Item(4)).gxTpr_Value, "."));
               AssignAttri("", false, "AV19RFMAct", StringUtil.LTrimStr( (decimal)(AV19RFMAct), 8, 0));
            }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?202091115385699", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("version1/wwtresumenrfm.js", "?202091115385699", false, true);
      ...
      public override void initialize( )
      {
         ...
         ROClassString = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.version1.wwtresumenrfm__default(),
            new Object[][] {
                new Object[] {
