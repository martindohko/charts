...
namespace GeneXus.Programs.version1 {
   public class home : GXHttpHandler
   {
      public home( )
      {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         if ( nGXWrapped != 1 )
         {
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"Form\" data-gx-class=\"Form\" novalidate action=\""+formatLink("version1.home.aspx") +"\">") ;
      ...
      {
         /* Load Routine */
         new GeneXus.Programs.version1.listprograms(context ).execute( out  AV6ProgramNames) ;
         AV10GXV1 = 1;
         while ( AV10GXV1 <= AV6ProgramNames.Count )
         {
            AV7ProgramName = ((GeneXus.Programs.version1.SdtProgramNames_ProgramName)AV6ProgramNames.Item(AV10GXV1));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?202091115385598", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("version1/home.js", "?202091115385598", false, true);
         }
      ...
      public override void initialize( )
      {
         ...
         sEvtType = "";
         AV5MenuItem = "";
         AV6ProgramNames = new GXBaseCollection<GeneXus.Programs.version1.SdtProgramNames_ProgramName>( context, "ProgramName", "RFM");
         AV7ProgramName = new GeneXus.Programs.version1.SdtProgramNames_ProgramName(context);
      ...
      private GXBaseCollection<GeneXus.Programs.version1.SdtProgramNames_ProgramName> AV6ProgramNames ;
      private GeneXus.Programs.version1.SdtProgramNames_ProgramName AV7ProgramName ;
   }
