...
gx.define('version1.wccantcli', true, function (CmpContext) {
   this.ServerClass =  "version1.wccantcli" ;
   ...
   {
      this.AV16corte1=gx.fn.getIntegerValue("vCORTE1",',') ;
      this.AV15corte2=gx.fn.getIntegerValue("vCORTE2",',') ;
   };
   ...
   QUERYVIEWER1Container.setProp("ObjectName", "Objectname", "QKPIChart1", "str");
   ...
   this.AV16corte1 = 0 ;
   this.AV15corte2 = 0 ;
   this.Events = {"e120x2_client": ["ENTER", true] ,"e130x2_client": ["CANCEL", true]};
   this.EvtParms["REFRESH"] = [[],[]];
   this.EvtParms["LOAD"] = [[{av:'AV16corte1',fld:'vCORTE1',pic:'ZZZZZZZ9'},{av:'AV5Parameters',fld:'vPARAMETERS',pic:''},{av:'AV15corte2',fld:'vCORTE2',pic:'ZZZZZZZ9'}],[{av:'AV5Parameters',fld:'vPARAMETERS',pic:''}]];
   this.setVCMap("AV16corte1", "vCORTE1", 0, "int", 8, 0);
   this.setVCMap("AV15corte2", "vCORTE2", 0, "int", 8, 0);
   this.Initialize( );
});
