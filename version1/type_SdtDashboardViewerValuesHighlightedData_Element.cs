...
namespace GeneXus.Programs.version1
{
	...
	[XmlType(TypeName="DashboardViewerValuesHighlightedData.Element" , Namespace="RFM" )]
	[Serializable]
	...
	[DataContract(Name=@"DashboardViewerValuesHighlightedData.Element", Namespace="RFM")]
