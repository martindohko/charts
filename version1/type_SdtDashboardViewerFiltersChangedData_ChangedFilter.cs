...
namespace GeneXus.Programs.version1
{
	...
	[XmlType(TypeName="DashboardViewerFiltersChangedData.ChangedFilter" , Namespace="RFM" )]
	[Serializable]
	...
	[DataContract(Name=@"DashboardViewerFiltersChangedData.ChangedFilter", Namespace="RFM")]
