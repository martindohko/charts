...
namespace GeneXus.Programs.version1 {
   public class promptmasterpage : GXMasterPage
   {
      ...
      protected void RenderHtmlCloseForm032( )
      {
         ...
         context.AddJavascriptSource("version1/promptmasterpage.js", "?202091115385570", false, true);
      ...
      {
         return "Version1.PromptMasterPage" ;
      }
      ...
      protected void wb_table6_24_032( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblock1_Internalname, "Footer Info", "", "", lblTextblock1_Jsonclick, "'"+""+"'"+",true,"+"'"+"E_MPAGE."+"'", "", "SmallText", 0, "", 1, 1, 0, "HLP_Version1\\PromptMasterPage.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "</tbody>") ;
            /* End of table */
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("version1/promptmasterpage.js", "?202091115385578", false, true);
         }
