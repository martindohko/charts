...
gx.define('version1.tabbedview', true, function (CmpContext) {
   this.ServerClass =  "version1.tabbedview" ;
   ...
   HISTORYMANAGERContainer.addEventHandler("URLChanged", this.e110b2_client);
   ...
   this.AV6Found = false ;
   this.Events = {"e110b2_client": ["HISTORYMANAGER.URLCHANGED", true] ,"e150b2_client": ["ENTER", true] ,"e160b2_client": ["CANCEL", true]};
   ...
   this.setVCMap("AV18Tabs", "TABS", 0, "CollVersion1\TabOptions.TabOptionsItem", 0, 0);
   ...
   this.setVCMap("AV14Tab", "vTAB", 0, "Version1\TabOptions.TabOptionsItem", 0, 0);
