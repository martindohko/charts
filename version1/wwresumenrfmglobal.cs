...
namespace GeneXus.Programs.version1 {
   public class wwresumenrfmglobal : GXHttpHandler
   {
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV21Pgmname = "Version1.WWResumenRFMGlobal";
               context.Gx_err = 0;
               WS122( ) ;
               if ( ! isAjaxCallMode( ) )
               {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202091115385776", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("version1.wwresumenrfmglobal.aspx") +"\">") ;
      ...
      {
         return "Version1.WWResumenRFMGlobal" ;
      }
      ...
      protected void WB120( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtntoggle_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(73), 2, 0)+","+"null"+");", bttBtntoggle_Caption, bttBtntoggle_Jsonclick, 7, "Hide Filters", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e11121_client"+"'", TempTags, "", 2, "HLP_Version1\\WWResumenRFMGlobal.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-6 col-sm-2", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTitletext_Internalname, "Resumen RFMGlobals", "", "", lblTitletext_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "SubTitle", 0, "", 1, 1, 0, "HLP_Version1\\WWResumenRFMGlobal.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblorderby_Internalname, lblLblorderby_Caption, "", "", lblLblorderby_Jsonclick, "'"+""+"'"+",false,"+"'"+"e12121_client"+"'", "", "WWAdvancedLabel WWOrderByLabel", 7, "", 1, 1, 1, "HLP_Version1\\WWResumenRFMGlobal.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblOrderby1_Internalname, "Periodo", "", "", lblOrderby1_Jsonclick, "'"+""+"'"+",false,"+"'"+"EORDERBY1.CLICK."+"'", "", lblOrderby1_Class, 5, "", 1, 1, 0, "HLP_Version1\\WWResumenRFMGlobal.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-lg-6 OrdersCell", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblOrderby2_Internalname, "Corte1", "", "", lblOrderby2_Jsonclick, "'"+""+"'"+",false,"+"'"+"EORDERBY2.CLICK."+"'", "", lblOrderby2_Class, 5, "", 1, 1, 0, "HLP_Version1\\WWResumenRFMGlobal.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-lg-6 OrdersCell", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblOrderby3_Internalname, "Corte2", "", "", lblOrderby3_Jsonclick, "'"+""+"'"+",false,"+"'"+"EORDERBY3.CLICK."+"'", "", lblOrderby3_Class, 5, "", 1, 1, 0, "HLP_Version1\\WWResumenRFMGlobal.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-lg-6 OrdersCell", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblOrderby4_Internalname, "RFM", "", "", lblOrderby4_Jsonclick, "'"+""+"'"+",false,"+"'"+"EORDERBY4.CLICK."+"'", "", lblOrderby4_Class, 5, "", 1, 1, 0, "HLP_Version1\\WWResumenRFMGlobal.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblcorte1filter_Internalname, lblLblcorte1filter_Caption, "", "", lblLblcorte1filter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e13121_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 1, "HLP_Version1\\WWResumenRFMGlobal.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblcorte2filter_Internalname, lblLblcorte2filter_Caption, "", "", lblLblcorte2filter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e14121_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 1, "HLP_Version1\\WWResumenRFMGlobal.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblrfmfilter_Internalname, lblLblrfmfilter_Caption, "", "", lblLblrfmfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e15121_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 1, "HLP_Version1\\WWResumenRFMGlobal.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
      ...
      {
         /* Start Routine */
         if ( ! new GeneXus.Programs.version1.isauthorized(context).executeUdp(  AV21Pgmname) )
         {
            CallWebObject(formatLink("version1.notauthorized.aspx") + "?" + UrlEncode(StringUtil.RTrim(AV21Pgmname)));
      ...
      protected void S122( )
      {
         ...
         if ( StringUtil.StrCmp(AV7HTTPRequest.Method, "GET") == 0 )
         {
            ...
            {
               AV14Periodo = ((GeneXus.Programs.version1.SdtGridState_FilterValue)AV8GridState.gxTpr_Filtervalues.Item(1)).gxTpr_Value;
               AssignAttri("", false, "AV14Periodo", AV14Periodo);
               AV15Corte1 = (int)(NumberUtil.Val( ((GeneXus.Programs.version1.SdtGridState_FilterValue)AV8GridState.gxTpr_Filtervalues.Item(2)).gxTpr_Value, "."));
               AssignAttri("", false, "AV15Corte1", StringUtil.LTrimStr( (decimal)(AV15Corte1), 8, 0));
               AV16Corte2 = (int)(NumberUtil.Val( ((GeneXus.Programs.version1.SdtGridState_FilterValue)AV8GridState.gxTpr_Filtervalues.Item(3)).gxTpr_Value, "."));
               AssignAttri("", false, "AV16Corte2", StringUtil.LTrimStr( (decimal)(AV16Corte2), 8, 0));
               AV17RFM = (int)(NumberUtil.Val( ((GeneXus.Programs.version1.SdtGridState_FilterValue)AV8GridState.gxTpr_Filtervalues.Item(4)).gxTpr_Value, "."));
               AssignAttri("", false, "AV17RFM", StringUtil.LTrimStr( (decimal)(AV17RFM), 8, 0));
            }
      ...
      protected void S132( )
      {
         ...
         AV9GridStateFilterValue = new GeneXus.Programs.version1.SdtGridState_FilterValue(context);
      ...
      protected void S112( )
      {
         ...
         AV11TrnContext = new GeneXus.Programs.version1.SdtTransactionContext(context);
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?20209111538590", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("version1/wwresumenrfmglobal.js", "?20209111538590", false, true);
      ...
      public override void initialize( )
      {
         ...
         AV8GridState = new GeneXus.Programs.version1.SdtGridState(context);
         ...
         ROClassString = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.version1.wwresumenrfmglobal__default(),
            new Object[][] {
                new Object[] {
      ...
      private GeneXus.Programs.version1.SdtGridState AV8GridState ;
      private GeneXus.Programs.version1.SdtGridState_FilterValue AV9GridStateFilterValue ;
      private GeneXus.Programs.version1.SdtTransactionContext AV11TrnContext ;
   }
