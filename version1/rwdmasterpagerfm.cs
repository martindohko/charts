...
namespace GeneXus.Programs.version1 {
   public class rwdmasterpagerfm : GXMasterPage
   {
      ...
      protected void RenderHtmlCloseForm0F2( )
      {
         ...
         context.AddJavascriptSource("version1/rwdmasterpagerfm.js", "?20209111538569", false, true);
      ...
      {
         return "Version1.RwdMasterPageRFM" ;
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)(getDataAreaObject() == null ? Form : getDataAreaObject().GetForm()).Jscriptsrc.Item(idxLst))), "?202091115385614", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("version1/rwdmasterpagerfm.js", "?202091115385614", false, true);
         }
