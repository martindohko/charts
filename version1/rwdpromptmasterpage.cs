...
namespace GeneXus.Programs.version1 {
   public class rwdpromptmasterpage : GXMasterPage
   {
      ...
      protected void RenderHtmlCloseForm062( )
      {
         ...
         context.AddJavascriptSource("version1/rwdpromptmasterpage.js", "?202091115385585", false, true);
      ...
      {
         return "Version1.RwdPromptMasterPage" ;
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)(getDataAreaObject() == null ? Form : getDataAreaObject().GetForm()).Jscriptsrc.Item(idxLst))), "?202091115385588", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("version1/rwdpromptmasterpage.js", "?202091115385588", false, true);
         }
