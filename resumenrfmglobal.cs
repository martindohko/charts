...
namespace GeneXus.Programs {
   public class resumenrfmglobal : GXDataArea
   {
      ...
      protected void DrawControls( )
      {
         ...
         /* Text block */
         GxWebStd.gx_label_ctrl( context, lblTitle_Internalname, "Resumen RFMGlobal", "", "", lblTitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Title", 0, "", 1, 1, 0, "HLP_ResumenRFMGlobal.htm");
         ...
         StyleString = "";
         GxWebStd.gx_button_ctrl( context, bttBtn_first_Internalname, "", "", bttBtn_first_Jsonclick, 5, "", "", StyleString, ClassString, bttBtn_first_Visible, 0, "standard", "'"+""+"'"+",false,"+"'"+"EFIRST."+"'", TempTags, "", context.GetButtonType( ), "HLP_ResumenRFMGlobal.htm");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         /* Div Control */
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "left", "top", "", "", "div");
         ...
         StyleString = "";
         GxWebStd.gx_button_ctrl( context, bttBtn_previous_Internalname, "", "", bttBtn_previous_Jsonclick, 5, "", "", StyleString, ClassString, bttBtn_previous_Visible, 0, "standard", "'"+""+"'"+",false,"+"'"+"EPREVIOUS."+"'", TempTags, "", context.GetButtonType( ), "HLP_ResumenRFMGlobal.htm");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         /* Div Control */
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "left", "top", "", "", "div");
         ...
         ClassString = "BtnNext";
         StyleString = "";
         GxWebStd.gx_button_ctrl( context, bttBtn_next_Internalname, "", "", bttBtn_next_Jsonclick, 5, "", "", StyleString, ClassString, bttBtn_next_Visible, 0, "standard", "'"+""+"'"+",false,"+"'"+"ENEXT."+"'", TempTags, "", context.GetButtonType( ), "HLP_ResumenRFMGlobal.htm");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         /* Div Control */
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "left", "top", "", "", "div");
         ...
         ClassString = "BtnLast";
         StyleString = "";
         GxWebStd.gx_button_ctrl( context, bttBtn_last_Internalname, "", "", bttBtn_last_Jsonclick, 5, "", "", StyleString, ClassString, bttBtn_last_Visible, 0, "standard", "'"+""+"'"+",false,"+"'"+"ELAST."+"'", TempTags, "", context.GetButtonType( ), "HLP_ResumenRFMGlobal.htm");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         /* Div Control */
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "left", "top", "", "", "div");
         ...
         StyleString = "";
         GxWebStd.gx_button_ctrl( context, bttBtn_select_Internalname, "", "Select", bttBtn_select_Jsonclick, 5, "Select", "", StyleString, ClassString, bttBtn_select_Visible, 0, "standard", "'"+""+"'"+",false,"+"'"+"ESELECT."+"'", TempTags, "", 2, "HLP_ResumenRFMGlobal.htm");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         ...
         GxWebStd.gx_single_line_edit( context, edtPeriodo_Internalname, A7Periodo, StringUtil.RTrim( context.localUtil.Format( A7Periodo, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,34);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtPeriodo_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtPeriodo_Enabled, 1, "text", "", 6, "chr", 1, "row", 6, 0, 0, 0, 1, -1, -1, true, "", "left", true, "", "HLP_ResumenRFMGlobal.htm");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         ...
         GxWebStd.gx_single_line_edit( context, edtClientesDelMes_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A12ClientesDelMes), 10, 0, ".", "")), ((edtClientesDelMes_Enabled!=0) ? StringUtil.LTrim( context.localUtil.Format( (decimal)(A12ClientesDelMes), "ZZZZZZZZZ9")) : context.localUtil.Format( (decimal)(A12ClientesDelMes), "ZZZZZZZZZ9")), TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,59);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtClientesDelMes_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtClientesDelMes_Enabled, 0, "number", "1", 10, "chr", 1, "row", 10, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_ResumenRFMGlobal.htm");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         ...
         GxWebStd.gx_single_line_edit( context, edtMinRecencia_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A13MinRecencia), 10, 0, ".", "")), ((edtMinRecencia_Enabled!=0) ? StringUtil.LTrim( context.localUtil.Format( (decimal)(A13MinRecencia), "ZZZZZZZZZ9")) : context.localUtil.Format( (decimal)(A13MinRecencia), "ZZZZZZZZZ9")), TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,64);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtMinRecencia_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtMinRecencia_Enabled, 0, "number", "1", 10, "chr", 1, "row", 10, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_ResumenRFMGlobal.htm");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         ...
         GxWebStd.gx_single_line_edit( context, edtMaxRecencia_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A14MaxRecencia), 10, 0, ".", "")), ((edtMaxRecencia_Enabled!=0) ? StringUtil.LTrim( context.localUtil.Format( (decimal)(A14MaxRecencia), "ZZZZZZZZZ9")) : context.localUtil.Format( (decimal)(A14MaxRecencia), "ZZZZZZZZZ9")), TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,69);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtMaxRecencia_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtMaxRecencia_Enabled, 0, "number", "1", 10, "chr", 1, "row", 10, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_ResumenRFMGlobal.htm");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         ...
         GxWebStd.gx_single_line_edit( context, edtAvgRecencia_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A24AvgRecencia), 10, 0, ".", "")), ((edtAvgRecencia_Enabled!=0) ? StringUtil.LTrim( context.localUtil.Format( (decimal)(A24AvgRecencia), "ZZZZZZZZZ9")) : context.localUtil.Format( (decimal)(A24AvgRecencia), "ZZZZZZZZZ9")), TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,74);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtAvgRecencia_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtAvgRecencia_Enabled, 0, "number", "1", 10, "chr", 1, "row", 10, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_ResumenRFMGlobal.htm");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         ...
         GxWebStd.gx_single_line_edit( context, edtMinFrecuencia_Internalname, StringUtil.LTrim( StringUtil.NToC( A15MinFrecuencia, 10, 6, ".", "")), ((edtMinFrecuencia_Enabled!=0) ? StringUtil.LTrim( context.localUtil.Format( A15MinFrecuencia, "ZZ9.999999")) : context.localUtil.Format( A15MinFrecuencia, "ZZ9.999999")), TempTags+" onchange=\""+"gx.num.valid_decimal( this, ',','.','6');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_decimal( this, ',','.','6');"+";gx.evt.onblur(this,79);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtMinFrecuencia_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtMinFrecuencia_Enabled, 0, "text", "", 10, "chr", 1, "row", 10, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_ResumenRFMGlobal.htm");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         ...
         GxWebStd.gx_single_line_edit( context, edtMaxFrecuencia_Internalname, StringUtil.LTrim( StringUtil.NToC( A16MaxFrecuencia, 10, 6, ".", "")), ((edtMaxFrecuencia_Enabled!=0) ? StringUtil.LTrim( context.localUtil.Format( A16MaxFrecuencia, "ZZ9.999999")) : context.localUtil.Format( A16MaxFrecuencia, "ZZ9.999999")), TempTags+" onchange=\""+"gx.num.valid_decimal( this, ',','.','6');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_decimal( this, ',','.','6');"+";gx.evt.onblur(this,84);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtMaxFrecuencia_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtMaxFrecuencia_Enabled, 0, "text", "", 10, "chr", 1, "row", 10, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_ResumenRFMGlobal.htm");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         ...
         GxWebStd.gx_single_line_edit( context, edtAvgFrecuencia_Internalname, StringUtil.LTrim( StringUtil.NToC( A17AvgFrecuencia, 10, 6, ".", "")), ((edtAvgFrecuencia_Enabled!=0) ? StringUtil.LTrim( context.localUtil.Format( A17AvgFrecuencia, "ZZ9.999999")) : context.localUtil.Format( A17AvgFrecuencia, "ZZ9.999999")), TempTags+" onchange=\""+"gx.num.valid_decimal( this, ',','.','6');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_decimal( this, ',','.','6');"+";gx.evt.onblur(this,89);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtAvgFrecuencia_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtAvgFrecuencia_Enabled, 0, "text", "", 10, "chr", 1, "row", 10, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_ResumenRFMGlobal.htm");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         ...
         StyleString = "";
         GxWebStd.gx_button_ctrl( context, bttBtn_enter_Internalname, "", "Confirm", bttBtn_enter_Jsonclick, 5, "Confirm", "", StyleString, ClassString, bttBtn_enter_Visible, bttBtn_enter_Enabled, "standard", "'"+""+"'"+",false,"+"'"+"EENTER."+"'", TempTags, "", context.GetButtonType( ), "HLP_ResumenRFMGlobal.htm");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         /* Div Control */
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "left", "top", "", "", "div");
         ...
         StyleString = "";
         GxWebStd.gx_button_ctrl( context, bttBtn_cancel_Internalname, "", "Cancel", bttBtn_cancel_Jsonclick, 1, "Cancel", "", StyleString, ClassString, bttBtn_cancel_Visible, 1, "standard", "'"+""+"'"+",false,"+"'"+"ECANCEL."+"'", TempTags, "", context.GetButtonType( ), "HLP_ResumenRFMGlobal.htm");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         /* Div Control */
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "left", "top", "", "", "div");
         ...
         StyleString = "";
         GxWebStd.gx_button_ctrl( context, bttBtn_delete_Internalname, "", "Delete", bttBtn_delete_Jsonclick, 5, "Delete", "", StyleString, ClassString, bttBtn_delete_Visible, bttBtn_delete_Enabled, "standard", "'"+""+"'"+",false,"+"'"+"EDELETE."+"'", TempTags, "", context.GetButtonType( ), "HLP_ResumenRFMGlobal.htm");
         GxWebStd.gx_div_end( context, "left", "top", "div");
         GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void standaloneStartupServer( )
      {
         ...
         if ( AnyError == 0 )
         {
            if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
            {
               ...
               {
                  GXUtil.WriteLogError("resumenrfmglobal:[ SecurityCheckFailed (403 Forbidden) value for]"+forbiddenHiddens.ToJSonString());
                  GxWebError = 1;
      ...
      protected void E12072( )
      {
         ...
         {
            CallWebObject(formatLink("wwresumenrfmglobal.aspx") );
            context.wjLocDisableFrm = 1;
         }
      ...
      protected void CheckOptimisticConcurrency073( )
      {
         if ( ! IsIns( ) )
         {
            ...
            if ( Gx_longc || ( Z22ComprasImporte_AnioMovil != T00072_A22ComprasImporte_AnioMovil[0] ) || ( Z23ComprasArticulos_AnioMovil != T00072_A23ComprasArticulos_AnioMovil[0] ) )
            {
               ...
               {
                  GXUtil.WriteLog("resumenrfmglobal:[seudo value changed for attri]"+"ClientesDelMes");
               ...
               {
                  GXUtil.WriteLog("resumenrfmglobal:[seudo value changed for attri]"+"MinRecencia");
               ...
               {
                  GXUtil.WriteLog("resumenrfmglobal:[seudo value changed for attri]"+"MaxRecencia");
               ...
               {
                  GXUtil.WriteLog("resumenrfmglobal:[seudo value changed for attri]"+"AvgRecencia");
               ...
               {
                  GXUtil.WriteLog("resumenrfmglobal:[seudo value changed for attri]"+"MinFrecuencia");
               ...
               {
                  GXUtil.WriteLog("resumenrfmglobal:[seudo value changed for attri]"+"MaxFrecuencia");
               ...
               {
                  GXUtil.WriteLog("resumenrfmglobal:[seudo value changed for attri]"+"AvgFrecuencia");
               ...
               {
                  GXUtil.WriteLog("resumenrfmglobal:[seudo value changed for attri]"+"MinValorMonetario");
               ...
               {
                  GXUtil.WriteLog("resumenrfmglobal:[seudo value changed for attri]"+"MaxValorMonetario");
               ...
               {
                  GXUtil.WriteLog("resumenrfmglobal:[seudo value changed for attri]"+"AvgValorMonetario");
               ...
               {
                  GXUtil.WriteLog("resumenrfmglobal:[seudo value changed for attri]"+"ComprasTickets_AnioMovil");
               ...
               {
                  GXUtil.WriteLog("resumenrfmglobal:[seudo value changed for attri]"+"ComprasImporte_AnioMovil");
               ...
               {
                  GXUtil.WriteLog("resumenrfmglobal:[seudo value changed for attri]"+"ComprasArticulos_AnioMovil");
      ...
      protected void EndLevel073( )
      {
         ...
         {
            pr_default.close(1);
            context.CommitDataStores("resumenrfmglobal",pr_default);
            if ( AnyError == 0 )
            {
               ConfirmValues070( ) ;
            }
         ...
         {
            pr_default.close(1);
            context.RollbackDataStores("resumenrfmglobal",pr_default);
         }
         IsModified = 0;
         if ( AnyError != 0 )
         {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202099155329", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("resumenrfmglobal.aspx") + "?" + UrlEncode(StringUtil.RTrim(Gx_mode)) + "," + UrlEncode(StringUtil.RTrim(AV7Periodo))+"\">") ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         GXUtil.WriteLogInfo("resumenrfmglobal:[ SendSecurityCheck value for]"+forbiddenHiddens.ToJSonString());
      }
      ...
      {
         return formatLink("resumenrfmglobal.aspx") + "?" + UrlEncode(StringUtil.RTrim(Gx_mode)) + "," + UrlEncode(StringUtil.RTrim(AV7Periodo)) ;
      }

      public override String GetPgmname( )
      {
         return "ResumenRFMGlobal" ;
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?202099155337", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("resumenrfmglobal.js", "?202099155337", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "Resumen RFMGlobal";
         bttBtn_delete_Enabled = 0;
      ...
      public override void initialize( )
      {
         ...
         FormProcess = "";
         bodyStyle = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.resumenrfmglobal__default(),
            new Object[][] {
                new Object[] {
