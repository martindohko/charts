...
namespace GeneXus.Programs.version2 {
   public class wpinicio : GXHttpHandler
   {
      public wpinicio( )
      {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202091116254367", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("version2.wpinicio.aspx") +"\">") ;
      ...
      protected void WB1N0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblock1_Internalname, "Inicio", "", "", lblTextblock1_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, "HLP_Version2\\WPInicio.htm");
            ...
            if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) && ! wbErr )
            {
               ...
               if ( StringUtil.Len( sEvt) > 0 )
               {
                  ...
                  else if ( StringUtil.StrCmp(sEvtType, "W") == 0 )
                  {
                     ...
                     if ( nCmpId == 9 )
                     {
                        WebComp_Component1 = getWebComponent(GetType(), "GeneXus.Programs", "version2.wcpieplotly", new Object[] {context} );
                        WebComp_Component1.ComponentInit();
                        WebComp_Component1.Name = "Version2.WCPiePlotly";
                        WebComp_Component1_Component = "Version2.WCPiePlotly";
                        WebComp_Component1.componentprocess("W0009", "", sEvt);
                     }
                     else if ( nCmpId == 11 )
                     {
                        WebComp_Component2 = getWebComponent(GetType(), "GeneXus.Programs", "version2.wcsankeyplotly", new Object[] {context} );
                        WebComp_Component2.ComponentInit();
                        WebComp_Component2.Name = "Version2.WCSankeyPlotly";
                        WebComp_Component2_Component = "Version2.WCSankeyPlotly";
                        WebComp_Component2.componentprocess("W0011", "", sEvt);
                     }
                  }
                  context.wbHandled = 1;
               }
      ...
      protected void RF1N2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            WebComp_Component2.componentprepare(new Object[] {(String)"W0011",(String)""});
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?202091116254371", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("version2/wpinicio.js", "?202091116254371", false, true);
