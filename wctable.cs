...
namespace GeneXus.Programs {
   public class wctable : GXWebComponent
   {
      public wctable( )
      {
      ...
      public wctable( IGxContext context )
      {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20209915535491", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            if ( nGXWrapped != 1 )
            {
               context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("wctable.aspx") +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"QUERYVIEWER1_Autoresize", StringUtil.BoolToStr( Queryviewer1_Autoresize));
      }
      ...
      protected void RenderHtmlCloseForm1G2( )
      {
         ...
         {
            context.AddJavascriptSource("wctable.js", "?20209915535496", false, true);
         }
      ...
      protected void WB1G0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "wctable.aspx");
               context.AddJavascriptSource("QueryViewer/QueryViewerCommon.js", "", false, true);
               context.AddJavascriptSource("QueryViewer/highcharts/highcharts.js", "", false, true);
               context.AddJavascriptSource("QueryViewer/highcharts/highcharts-3d.js", "", false, true);
               context.AddJavascriptSource("QueryViewer/highcharts/highcharts-more.js", "", false, true);
      ...
      protected void START1G2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            if ( ! context.isSpaRequest( ) )
            {
               ...
               Form.Meta.addItem("description", "WCTable", 0) ;
            }
            context.wjLoc = "";
      ...
      protected void STRUP1G0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            Queryviewer1_Autoresize = StringUtil.StrToBool( cgiGet( sPrefix+"QUERYVIEWER1_Autoresize"));
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "wctable", GetJustCreated( ));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?20209915535512", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("wctable.js", "?20209915535512", false, true);
            context.AddJavascriptSource("QueryViewer/QueryViewerCommon.js", "", false, true);
            context.AddJavascriptSource("QueryViewer/highcharts/highcharts.js", "", false, true);
            context.AddJavascriptSource("QueryViewer/highcharts/highcharts-3d.js", "", false, true);
            context.AddJavascriptSource("QueryViewer/highcharts/highcharts-more.js", "", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         init_default_properties( ) ;
         Queryviewer1_Autoresize = Convert.ToBoolean( 0);
         Queryviewer1_Objectname = "QTableChart";
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            if ( context.isSpaRequest( ) )
            {
      ...
      public override void initialize( )
      {
         ...
         bodyStyle = "";
         GXKey = "";
         AV7Axes = new GXBaseCollection<SdtQueryViewerAxes_Axis>( context, "Axis", "RFM");
         AV5Parameters = new GXBaseCollection<SdtQueryViewerParameters_Parameter>( context, "Parameter", "RFM");
      ...
      private bool Queryviewer1_Autoresize ;
      private bool wbLoad ;
      private bool Rfr0gs ;
      private bool wbErr ;
      ...
      private GXBaseCollection<SdtQueryViewerAxes_Axis> AV7Axes ;
