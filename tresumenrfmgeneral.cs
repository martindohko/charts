   ...
   public class tresumenrfmgeneral : GXWebComponent
   {
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV14Pgmname = "tResumenRFMGeneral";
               context.Gx_err = 0;
               WS0E2( ) ;
               if ( ! isAjaxCallMode( ) )
               {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202091012265525", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            if ( nGXWrapped != 1 )
            {
               context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("tresumenrfmgeneral.aspx") + "?" + UrlEncode("" +A1Region) + "," + UrlEncode("" +A2Sucursal)+"\">") ;
      ...
      protected void RenderHtmlCloseForm0E2( )
      {
         ...
         {
            context.AddJavascriptSource("tresumenrfmgeneral.js", "?202091012265526", false, true);
         }
      ...
      protected void WB0E0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "tresumenrfmgeneral.aspx");
            }
            ...
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtRegion_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A1Region), 4, 0, ".", "")), ((edtRegion_Enabled!=0) ? StringUtil.LTrim( context.localUtil.Format( (decimal)(A1Region), "ZZZ9")) : context.localUtil.Format( (decimal)(A1Region), "ZZZ9")), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtRegion_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtRegion_Enabled, 0, "number", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_tResumenRFMGeneral.htm");
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "tresumenrfmgeneral", GetJustCreated( ));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?202091012265537", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("tresumenrfmgeneral.js", "?202091012265537", false, true);
         }
      ...
      public override void initialize( )
      {
         ...
         sCtrlA1Region = "";
         sCtrlA2Sucursal = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.tresumenrfmgeneral__default(),
            new Object[][] {
                new Object[] {
