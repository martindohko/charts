...
namespace GeneXus.Programs {
   public class viewresumenrfmglobal : GXDataArea
   {
      public viewresumenrfmglobal( )
      {
      ...
      public viewresumenrfmglobal( IGxContext context )
      {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            {
               AV12Periodo = gxfirstwebparm;
               AssignAttri("", false, "AV12Periodo", AV12Periodo);
               GxWebStd.gx_hidden_field( context, "gxhash_vPERIODO", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV12Periodo, "")), context));
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?2020981141395", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("viewresumenrfmglobal.aspx") + "?" + UrlEncode(StringUtil.RTrim(AV12Periodo)) + "," + UrlEncode(StringUtil.RTrim(AV6TabCode))+"\">") ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         forbiddenHiddens.Add("hshsalt", "hsh"+"ViewResumenRFMGlobal");
         forbiddenHiddens.Add("Corte1", context.localUtil.Format( (decimal)(A8Corte1), "ZZZZZZZ9"));
         GxWebStd.gx_hidden_field( context, "hsh", GetEncryptedHash( forbiddenHiddens.ToString(), GXKey));
         GXUtil.WriteLogInfo("viewresumenrfmglobal:[ SendSecurityCheck value for]"+forbiddenHiddens.ToJSonString());
      }
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vPERIODO", AV12Periodo);
         GxWebStd.gx_hidden_field( context, "gxhash_vPERIODO", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV12Periodo, "")), context));
      ...
      {
         return formatLink("viewresumenrfmglobal.aspx") + "?" + UrlEncode(StringUtil.RTrim(AV12Periodo)) + "," + UrlEncode(StringUtil.RTrim(AV6TabCode)) ;
      }

      public override String GetPgmname( )
      {
         return "ViewResumenRFMGlobal" ;
      }

      public override String GetPgmdesc( )
      {
         return "View Resumen RFMGlobal" ;
      }
      ...
      protected void WB110( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblViewtitle_Internalname, "Resumen RFMGlobal Information", "", "", lblViewtitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "SubTitle", 0, "", 1, 1, 0, "HLP_ViewResumenRFMGlobal.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-4 ViewActionsBackCell", "Right", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblViewall_Internalname, "Resumen RFMGlobals", lblViewall_Link, "", lblViewall_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "BtnTextBlockBack", 0, "", lblViewall_Visible, 1, 0, "HLP_ViewResumenRFMGlobal.htm");
            ...
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtCorte1_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A8Corte1), 8, 0, ".", "")), ((edtCorte1_Enabled!=0) ? StringUtil.LTrim( context.localUtil.Format( (decimal)(A8Corte1), "ZZZZZZZ9")) : context.localUtil.Format( (decimal)(A8Corte1), "ZZZZZZZ9")), "", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtCorte1_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtCorte1_Enabled, 0, "number", "1", 8, "chr", 1, "row", 8, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_ViewResumenRFMGlobal.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGeneral_title_Internalname, "General", "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, "HLP_ViewResumenRFMGlobal.htm");
            /* Div Control */
      ...
      protected void START112( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "View Resumen RFMGlobal", 0) ;
         }
         context.wjLoc = "";
      ...
      {
         /* GeneXus formulas. */
         AV15Pgmname = "ViewResumenRFMGlobal";
         context.Gx_err = 0;
      }
      ...
      protected void RF112( )
      {
         ...
         {
            /* Using cursor H00112 */
            pr_default.execute(0, new Object[] {AV12Periodo});
            while ( (pr_default.getStatus(0) != 101) )
            {
               A7Periodo = H00112_A7Periodo[0];
               A8Corte1 = H00112_A8Corte1[0];
      ...
      protected void STRUP110( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            {
               GXUtil.WriteLogError("viewresumenrfmglobal:[ SecurityCheckFailed (403 Forbidden) value for]"+forbiddenHiddens.ToJSonString());
               GxWebError = 1;
      ...
      protected void E11112( )
      {
         ...
         AV16GXLvl6 = 0;
         /* Using cursor H00113 */
         pr_default.execute(1, new Object[] {AV12Periodo});
         while ( (pr_default.getStatus(1) != 101) )
         {
            A7Periodo = H00113_A7Periodo[0];
            A8Corte1 = H00113_A8Corte1[0];
            AssignAttri("", false, "A8Corte1", StringUtil.LTrimStr( (decimal)(A8Corte1), 8, 0));
            AV16GXLvl6 = 1;
            Form.Caption = StringUtil.Str( (decimal)(A8Corte1), 8, 0);
            AssignProp("", false, "FORM", "Caption", Form.Caption, true);
            lblViewall_Link = formatLink("wwresumenrfmglobal.aspx") ;
      ...
      protected void S112( )
      {
         ...
         {
            /* Object Property */
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Generalwc_Component), StringUtil.Lower( "ResumenRFMGlobalGeneral")) != 0 )
            {
               WebComp_Generalwc = getWebComponent(GetType(), "GeneXus.Programs", "resumenrfmglobalgeneral", new Object[] {context} );
               WebComp_Generalwc.ComponentInit();
               WebComp_Generalwc.Name = "ResumenRFMGlobalGeneral";
               WebComp_Generalwc_Component = "ResumenRFMGlobalGeneral";
            }
            if ( StringUtil.Len( WebComp_Generalwc_Component) != 0 )
            {
               WebComp_Generalwc.setjustcreated();
               WebComp_Generalwc.componentprepare(new Object[] {(String)"W0030",(String)"",(String)AV12Periodo});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV12Periodo = (String)getParm(obj,0);
         AssignAttri("", false, "AV12Periodo", AV12Periodo);
         GxWebStd.gx_hidden_field( context, "gxhash_vPERIODO", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV12Periodo, "")), context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?2020981141411", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("viewresumenrfmglobal.js", "?2020981141411", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "View Resumen RFMGlobal";
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV12Periodo',fld:'vPERIODO',pic:'',hsh:true},{av:'AV6TabCode',fld:'vTABCODE',pic:'',hsh:true},{av:'A8Corte1',fld:'CORTE1',pic:'ZZZZZZZ9'}]");
      ...
      public override void initialize( )
      {
         ...
         AV15Pgmname = "";
         scmdbuf = "";
         H00112_A7Periodo = new String[] {""} ;
         H00112_A8Corte1 = new int[1] ;
         A7Periodo = "";
         hsh = "";
         H00113_A7Periodo = new String[] {""} ;
         H00113_A8Corte1 = new int[1] ;
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.viewresumenrfmglobal__default(),
            new Object[][] {
                new Object[] {
               H00112_A7Periodo, H00112_A8Corte1
               }
               , new Object[] {
               H00113_A7Periodo, H00113_A8Corte1
               }
            }
         );
      ...
      private String wcpOAV12Periodo ;
      ...
      private String[] H00112_A7Periodo ;
      private int[] H00112_A8Corte1 ;
      private String[] H00113_A7Periodo ;
      private int[] H00113_A8Corte1 ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
      private GXWebForm Form ;
   }

   public class viewresumenrfmglobal__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new Object[] {"@AV12Periodo",SqlDbType.NVarChar,6,0}
          } ;
          Object[] prmH00113 ;
          ...
          def= new CursorDef[] {
              new CursorDef("H00112", "SELECT [Periodo], [Corte1] FROM [ResumenRFMGlobal] WHERE [Periodo] = @AV12Periodo ORDER BY [Periodo] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00112,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H00113", "SELECT [Periodo], [Corte1] FROM [ResumenRFMGlobal] WHERE [Periodo] = @AV12Periodo ORDER BY [Periodo] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00113,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
