...
namespace GeneXus.Programs {
   public class gamexamplenotauthorized : GXHttpHandler
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20209111539116", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?20209111539181", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gamexamplenotauthorized.js", "?20209111539185", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("'LOGIN'","{handler:'E111Q2',iparms:[]");
