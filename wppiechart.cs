...
namespace GeneXus.Programs {
   public class wppiechart : GXDataArea
   {
      public wppiechart( )
      {
      ...
      public wppiechart( IGxContext context )
      {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?2020981654248", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("wppiechart.aspx") +"\">") ;
      ...
      {
         return formatLink("wppiechart.aspx")  ;
      }
      ...
      protected void WB0S0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            {
               /* WebComponent */
               GxWebStd.gx_hidden_field( context, "W0006"+"", StringUtil.RTrim( WebComp_Component1_Component));
               context.WriteHtmlText( "<div") ;
      ...
      protected void START0S2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "WPPie Chart", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void RF0S2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               WebComp_Component1 = getWebComponent(GetType(), "GeneXus.Programs", "wcpiecharttks", new Object[] {context} );
               WebComp_Component1.ComponentInit();
               WebComp_Component1.Name = "WCPieChartTks";
               WebComp_Component1_Component = "WCPieChartTks";
            }
            WebComp_Component1.setjustcreated();
            WebComp_Component1.componentprepare(new Object[] {(String)"W0006",(String)"",(GXBaseCollection<SdtQueryViewerParameters_Parameter>)AV8Parameters});
      ...
      protected void E110S2( )
      {
         ...
         GXt_int2 = (short)(AV5corte1);
         GXt_int3 = (short)(AV6corte2);
         new pparametros(context ).execute( ref  GXt_char1, out  GXt_int2, out  GXt_int3) ;
         AV5corte1 = GXt_int2;
         AV6corte2 = GXt_int3;
         AV7Parameter = new SdtQueryViewerParameters_Parameter(context);
         AV7Parameter.gxTpr_Name = "Corte1";
         AV7Parameter.gxTpr_Value = StringUtil.Str( (decimal)(AV5corte1), 8, 0);
         AV8Parameters.Add(AV7Parameter, 0);
         AV7Parameter = new SdtQueryViewerParameters_Parameter(context);
         AV7Parameter.gxTpr_Name = "Corte2";
         AV7Parameter.gxTpr_Value = StringUtil.Str( (decimal)(AV6corte2), 8, 0);
         AV8Parameters.Add(AV7Parameter, 0);
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?20209816542412", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wppiechart.js", "?20209816542412", false, true);
      ...
      public override void initialize( )
      {
         ...
         EvtRowId = "";
         sEvtType = "";
         AV8Parameters = new GXBaseCollection<SdtQueryViewerParameters_Parameter>( context, "Parameter", "RFM");
         GXt_char1 = "";
         AV7Parameter = new SdtQueryViewerParameters_Parameter(context);
      ...
      private SdtQueryViewerParameters_Parameter AV7Parameter ;
   }
