...
namespace GeneXus.Programs {
   public class wpcolumnchart : GXDataArea
   {
      public wpcolumnchart( )
      {
      ...
      public wpcolumnchart( IGxContext context )
      {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?2020989282937", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("wpcolumnchart.aspx") +"\">") ;
      ...
      {
         return formatLink("wpcolumnchart.aspx")  ;
      }

      public override String GetPgmname( )
      {
         return "WPColumnChart" ;
      }

      public override String GetPgmdesc( )
      {
         return "WPColumn Chart" ;
      }
      ...
      protected void START0R2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "WPColumn Chart", 0) ;
         }
         context.wjLoc = "";
               ...
               if ( StringUtil.Len( sEvt) > 0 )
               {
                  ...
                  if ( StringUtil.StrCmp(sEvtType, "M") != 0 )
                  {
                     ...
                     else if ( StringUtil.StrCmp(sEvtType, "W") == 0 )
                     {
                        ...
                        if ( nCmpId == 6 )
                        {
                           WebComp_Component1 = getWebComponent(GetType(), "GeneXus.Programs", "wccolumnchart", new Object[] {context} );
                           WebComp_Component1.ComponentInit();
                           WebComp_Component1.Name = "WCColumnChart";
                           WebComp_Component1_Component = "WCColumnChart";
      ...
      protected void RF0R2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            WebComp_Component1.componentprepare(new Object[] {(String)"W0006",(String)""});
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?2020989282941", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wpcolumnchart.js", "?2020989282941", false, true);
