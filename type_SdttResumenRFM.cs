...
namespace GeneXus.Programs {
   ...
   public class SdttResumenRFM : GxSilentTrnSdt
   {
      ...
      public void UpdateDirties( SdttResumenRFM sdt )
      {
      ...
      public void initialize( )
      {
         gxTv_SdttResumenRFM_Mode = "";
         IGxSilentTrn obj ;
         obj = (IGxSilentTrn)ClassLoader.FindInstance( "tresumenrfm", "GeneXus.Programs.tresumenrfm_bc", new Object[] {context}, constructorCallingAssembly);;
         obj.initialize();
         obj.SetSDT(this, 1);
         setTransaction( obj) ;
         obj.SetMode("INS");
   ...
   [DataContract(Name = @"tResumenRFM", Namespace = "RFM")]
   public class SdttResumenRFM_RESTInterface : GxGenericCollectionItem<SdttResumenRFM>
   {
      public SdttResumenRFM_RESTInterface( ) : base()
      {
      }

      public SdttResumenRFM_RESTInterface( SdttResumenRFM psdt ) : base(psdt)
      {
      }
      ...
      public SdttResumenRFM sdt
      {
         get {
            return (SdttResumenRFM)Sdt ;
         }
